...
public class HelloServiceLocator extends org.apache.axis.client.Service implements uestc.fnc.ws.hw1.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/Hello/services/Hello";
    ...
    public uestc.fnc.ws.hw1.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uestc.fnc.ws.hw1.HelloSoapBindingStub _stub = new uestc.fnc.ws.hw1.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uestc.fnc.ws.hw1.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                uestc.fnc.ws.hw1.HelloSoapBindingStub _stub = new uestc.fnc.ws.hw1.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://hw1.ws.fnc.uestc", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://hw1.ws.fnc.uestc", "Hello"));
        }
